...
#' @references
#' \itemize{
#' \item Cook, R. D. (1986). Assessment of local infuence (with discussion). Journal of
#' the Royal Statistical Society Serie B, 48, 133-169.
#' \item Lesafre E. and Verbeke G. (1998). Local infuence in linear mixed models. Biometrics, 54, 570-582.
