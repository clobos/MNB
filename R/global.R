#' Global influence
#'
#' @description  It performes influence analysis by a global influence to evaluate the impact on the parameter
...
#' trt*period + offset(log(weeks)),star=star,dataSet=seizures,plot=TRUE)
#'
#' dev.off()
#' #End(Not run)
#' @export
