...
#' it is avaliable the standardized deviance component residual for the ith subject
#' (Fabio et al., 2012).
#' @return Residuals
...
#'
#' r <- re.MNB(formula=Y ~ trt + period + offset(weeks),star=star,dataSet=seizures)
#' plot(r$ij.Sweighted.residual,cex.axis = 1.2, cex.lab = 1.2, pch = 15,cex = 0.6, bg = 5)
#' abline(h=c(-3,0,3),lwd = 2, lty = 2)
#' #identify(r$quantile.residual)
#'
#' dev.off()
#' #End(Not run)
#' @export
